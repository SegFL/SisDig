...
HD_PWD='C:/Users/Educacion/Desktop/SisDig/Vivado/Proyectos/universal_counter/universal_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log universal_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source universal_counter.tcl
